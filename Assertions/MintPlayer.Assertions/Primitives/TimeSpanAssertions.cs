...
public class TimeSpanAssertions
{
    ...
    /// <summary>Asserts the nullable subject has no value.</summary>
    public AndConstraint<TimeSpanAssertions> BeNull(string? because = null, params object?[] becauseArgs)
    {
        Assert().ForCondition(!Subject.HasValue).BecauseOf(because, becauseArgs)
    ...
    public AndWhichConstraint<TimeSpanAssertions, TimeSpan> NotBeNull(string? because = null, params object?[] becauseArgs)
    {
        Assert().ForCondition(Subject.HasValue).BecauseOf(because, becauseArgs)
