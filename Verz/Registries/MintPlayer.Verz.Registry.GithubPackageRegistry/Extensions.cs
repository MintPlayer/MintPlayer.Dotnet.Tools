...
{
    public static IServiceCollection AddGithubPackageRegistry(this IServiceCollection services, string organization)
        => services
            .AddSingleton<IGithubPackageRegistry>(provider => new GithubPackageRegistry(organization))
