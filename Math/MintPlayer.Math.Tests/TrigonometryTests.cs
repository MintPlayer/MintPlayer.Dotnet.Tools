...
public class TrigonometryTests
{
    ...
    public void Cosec_ReturnsReciprocalOfSine(double radians, double expected)
        => Trigonometry.Cosec(radians).Should().BeApproximately(expected, Tolerance);
    ...
    public void Sec_ReturnsReciprocalOfCosine(double radians, double expected)
        => Trigonometry.Sec(radians).Should().BeApproximately(expected, Tolerance);
    ...
    public void Cotan_ReturnsReciprocalOfTangent(double radians, double expected)
        => Trigonometry.Cotan(radians).Should().BeApproximately(expected, Tolerance);
    ...
    public void CosecH_ReturnsReciprocalOfSinh()
        => Trigonometry.CosecH(1d).Should().BeApproximately(1d / System.Math.Sinh(1d), Tolerance);

    [Fact]
    // sech(0) = 1/cosh(0) = 1/1 = 1
    public void SecH_AtZero_IsOne()
        => Trigonometry.SecH(0d).Should().BeApproximately(1d, Tolerance);
    ...
    public void CotanH_ForLargeInput_ApproachesOneFromAbove()
    {
        ...
        result.Should().BeApproximately(1d, 1e-8);
    }
    ...
    public void Acosec_IsInverseOfCosec(double value)
        => Trigonometry.Cosec(Trigonometry.Acosec(value)).Should().BeApproximately(value, 1e-10);
    ...
    public void Asec_IsInverseOfSec(double value)
        => Trigonometry.Sec(Trigonometry.Asec(value)).Should().BeApproximately(value, 1e-10);
    ...
    public void Acotan_IsInverseOfCotan(double value)
        => Trigonometry.Cotan(Trigonometry.Acotan(value)).Should().BeApproximately(value, 1e-10);

    [Fact]
    // asec(1) = acos(1) = 0
    public void Asec_AtOne_IsZero()
        => Trigonometry.Asec(1d).Should().BeApproximately(0d, Tolerance);

    [Fact]
    // acosec(1) = asin(1) = pi/2
    public void Acosec_AtOne_IsHalfPi()
        => Trigonometry.Acosec(1d).Should().BeApproximately(System.Math.PI / 2, Tolerance);
    ...
    public void AsinH_MatchesKnownValues(double value, double expected)
        => Trigonometry.AsinH(value).Should().BeApproximately(expected, 1e-10);

    [Fact]
    public void AsinH_AgreesWithTheBcl()
        => Trigonometry.AsinH(3.7d).Should().BeApproximately(System.Math.Asinh(3.7d), 1e-12);
    ...
    public void AcosH_MatchesKnownValues(double value, double expected)
        => Trigonometry.AcosH(value).Should().BeApproximately(expected, 1e-10);

    [Fact]
    public void AcosH_AgreesWithTheBcl()
        => Trigonometry.AcosH(4.2d).Should().BeApproximately(System.Math.Acosh(4.2d), 1e-12);
    ...
    public void AtanH_MatchesKnownValues(double value, double expected)
        => Trigonometry.AtanH(value).Should().BeApproximately(expected, 1e-10);

    [Fact]
    public void AtanH_AgreesWithTheBcl()
        => Trigonometry.AtanH(0.75d).Should().BeApproximately(System.Math.Atanh(0.75d), 1e-12);
    ...
    public void AcosecH_AtOne_EqualsAsinhOfOne()
        => Trigonometry.AcosecH(1d).Should().BeApproximately(System.Math.Asinh(1d), 1e-12);

    [Fact]
    public void AcosecH_IsInverseOfCosecH()
        => Trigonometry.CosecH(Trigonometry.AcosecH(2.5d)).Should().BeApproximately(2.5d, 1e-10);

    [Fact]
    // asech(x) = acosh(1/x), so asech(1) = acosh(1) = 0
    public void AsecH_AtOne_IsZero()
        => Trigonometry.AsecH(1d).Should().BeApproximately(0d, 1e-12);

    [Fact]
    public void AsecH_IsInverseOfSecH()
        => Trigonometry.SecH(Trigonometry.AsecH(0.4d)).Should().BeApproximately(0.4d, 1e-10);
    ...
    public void AcotanH_MatchesKnownValue()
        => Trigonometry.AcotanH(2d).Should().BeApproximately(0.5493061443340549d, 1e-10);

    [Fact]
    public void AcotanH_IsInverseOfCotanH()
        => Trigonometry.CotanH(Trigonometry.AcotanH(3d)).Should().BeApproximately(3d, 1e-10);
