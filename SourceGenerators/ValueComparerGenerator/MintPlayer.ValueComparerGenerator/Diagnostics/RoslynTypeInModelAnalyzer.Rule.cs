...
public sealed partial class RoslynTypeInModelAnalyzer : DiagnosticAnalyzer
{
    ...
    private static readonly DiagnosticDescriptor Rule = new(
        id: DiagnosticId,
        title: "[GenerateEquality] model holds a Roslyn type",
        messageFormat: "Property '{1}' of [GenerateEquality] type '{0}' holds the Roslyn type '{2}'. Project it to a Roslyn-agnostic value (a string, a LocationKey, a PathSpec) instead.",
        category: "Correctness",
        defaultSeverity: DiagnosticSeverity.Error,
        isEnabledByDefault: true,
        description: """
            Incremental-pipeline models should be CLR-agnostic.
            If a property of a [GenerateEquality] type (or of a type it reaches through collections, tuples or nested classes) holds a Microsoft.CodeAnalysis type
