...
| MintPlayer.ValueComparerGenerator.Attributes | `MintPlayer.ValueComparerGenerator.Attributes` | The attributes you decorate with. Referenced automatically by the generator package. |
