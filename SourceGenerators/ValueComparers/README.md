...
Ready-made `IEqualityComparer<T>` implementations for third-party types, for `[UseEqualityComparer]`, so incremental generators
...
To generate value equality for your own types, see
