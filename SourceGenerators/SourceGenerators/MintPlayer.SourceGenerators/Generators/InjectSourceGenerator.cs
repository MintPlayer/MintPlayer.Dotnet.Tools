...
public class InjectSourceGenerator : IncrementalGenerator
{
    ...
    public override void Initialize(IncrementalGeneratorInitializationContext context, IncrementalValueProvider<Settings> settingsProvider)
    {
        ...
        // The models implement IEquatable<T> (generated by [AutoValueComparer]), so Collect() compares
        // them by value: an edit that re-runs the transform without changing a model keeps this cached.
