...
public class ClassNamesSourceGenerator : IncrementalGenerator
{
    ...
    public override void Initialize(IncrementalGeneratorInitializationContext context, IncrementalValueProvider<Settings> settingsProvider)
    {
        ...
        var classesWithRegisterAttributeProvider = context.SyntaxProvider
            ...
            .WithComparer(ServiceRegistrationValueComparer.Instance)
            .Collect();

        Combine((classDeclarationsProvider, fieldDeclarationsProvider, classesWithRegisterAttributeProvider))
            .Select((classDeclarations, fieldDeclarations, classesWithRegisterAttribute) =>
            {
                return "";
            });
