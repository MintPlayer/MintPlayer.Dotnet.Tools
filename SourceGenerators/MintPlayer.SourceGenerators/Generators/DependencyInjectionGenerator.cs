            ...
            var classesWithRegisterAttributeProvider = context.SyntaxProvider
                .CreateSyntaxProvider(
                    ...
                    static (context2, ct) =>
                    {
                        ...
                        //    {
                        //        var res = classSymbol.GetAttributes()
                        //            .Where(a => a.AttributeClass?.Name == nameof(RegisterAttribute))
                        //            .Select(a => new ServiceRegistration
                        //            {
                        //                //ServiceTypeName = a.ConstructorArguments[0].Value is INamedTypeSymbol symbol
                        //                //    ? symbol.ToDisplayString(SymbolDisplayFormat.FullyQualifiedFormat)
                        //                //    : null,
                        //                //ImplementationTypeName = classSymbol.ToDisplayString(SymbolDisplayFormat.FullyQualifiedFormat),
                        //                ////Lifetime = a.ConstructorArguments[1].Value
                        //            })
                        //            .ToArray();
                        //        return res;
                        //    }
