...
public class ClassNamesSourceGenerator : IncrementalGenerator
{
    public override void Initialize(IncrementalGeneratorInitializationContext context, IncrementalValueProvider<Settings> settingsProvider)
    {
        ...
        var classNamesSourceProvider = classDeclarationsProvider
            ...
            .WithProducer(static (p, ct) => new Producers.ClassNamesProducer(declarations: p.Left, rootNamespace: p.Right.RootNamespace!));

        var classNameListSourceProvider = classDeclarationsProvider
            .Combine(settingsProvider)
            .WithProducer(static (p, ct) => new Producers.ClassNameListProducer(declarations: p.Left, rootNamespace: p.Right.RootNamespace!));
