...
public class EidCard : Card
{
    ...
    static EidCard()
    {
        fileSelectors.Add(EEidFile.AuthCert, [0x3F, 0x00, 0xDF, 0x00, 0x50, 0x38]);
        fileSelectors.Add(EEidFile.SignCert, [0x3F, 0x00, 0xDF, 0x00, 0x50, 0x39]);
        fileSelectors.Add(EEidFile.CaCert, [0x3F, 0x00, 0xDF, 0x00, 0x50, 0x3A]);
        fileSelectors.Add(EEidFile.RootCert, [0x3F, 0x00, 0xDF, 0x00, 0x50, 0x3B]);
        fileSelectors.Add(EEidFile.RrnCert, [0x3F, 0x00, 0xDF, 0x00, 0x50, 0x3C]);

        fileSelectors.Add(EEidFile.Id, [0x3F, 0x00, 0xDF, 0x01, 0x40, 0x31]);
        fileSelectors.Add(EEidFile.IdSig, [0x3F, 0x00, 0xDF, 0x01, 0x40, 0x32]);
        fileSelectors.Add(EEidFile.Address, [0x3F, 0x00, 0xDF, 0x01, 0x40, 0x33]);
        fileSelectors.Add(EEidFile.AddressSig, [0x3F, 0x00, 0xDF, 0x01, 0x40, 0x34]);
        fileSelectors.Add(EEidFile.Picture, [0x3F, 0x00, 0xDF, 0x01, 0x40, 0x35]);
    }
